...
decisions:
  - label: "LIGHTING"
    body: "Sunrise from the east, viewer facing north — the light comes in at a low angle from the right, which does two things. It creates long shadows that give the terrain texture and depth, and it creates natural dark pockets on the left side of every tree, every rock, every rise in the ground. Those dark pockets are where I hid the figure. The sunrise isn't just beautiful — it's doing work. It's creating the exact conditions that make concealment possible."
  - label: "COMPOSITION"
